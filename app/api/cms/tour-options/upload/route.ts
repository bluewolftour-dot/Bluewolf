...
const uploadDir = path.join(process.cwd(), "public", "uploads", "cms", "tour-options");
const allowedSlotPattern = /^tour-option-\d+-photo-\d+$/;
...
export async function POST(request: Request) {
    ...
    return NextResponse.json({
        path: `/uploads/cms/tour-options/${fileName}`,
    });
}
