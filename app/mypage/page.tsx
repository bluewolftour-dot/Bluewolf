...
const myCopy = {
    ko: {
        title: "마이페이지",
        desc: "예약 내역과 취소 진행 상태, 작성 글, 알림을 한곳에서 확인하세요.",
        ...
        bookingsTitle: "회원 예약 확인",
        bookingsDesc: "예약 번호 입력 없이 회원 전용 페이지에서 모든 예약을 확인할 수 있습니다.",
        bookingsCta: "예약 확인 페이지 열기",
        bookingsBadge: "회원 전용",
        ...
        withdrawModalDesc: "회원 정보가 즉시 삭제되며 모든 기기에서 자동 로그아웃됩니다. 이미 진행 중인 예약 내역은 보존되지만, 마이페이지에서는 더 이상 자동으로 조회할 수 없습니다.",
    ...
    ja: {
        title: "マイページ",
        desc: "予約・キャンセル状況、投稿、通知をまとめて確認できます。",
        ...
        bookingsTitle: "会員予約確認",
        bookingsDesc: "予約番号の入力なしで、会員専用ページで全ての予約を確認できます。",
        bookingsCta: "予約確認ページを開く",
        bookingsBadge: "会員専用",
        ...
        withdrawModalDesc: "会員情報はすぐに削除され、すべての端末から自動的にログアウトされます。進行中の予約履歴は保持されますが、マイページからは自動で確認できなくなります。",
    ...
    en: {
        title: "My Page",
        desc: "Manage your bookings, posts, applications, and notifications in one place.",
        ...
        bookingsTitle: "Member Bookings",
        bookingsDesc: "View all your bookings on the members-only page without entering a booking number.",
        bookingsCta: "Open booking dashboard",
        ...
        withdrawModalDesc: "Your account will be deleted immediately and you'll be signed out everywhere. Existing bookings remain on file, but you can no longer view them automatically from My Page.",
