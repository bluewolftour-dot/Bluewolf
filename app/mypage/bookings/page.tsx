...
const myBookingsCopy = {
    ko: {
        title: "회원 예약 확인",
        subtitle: "내 예약 내역",
        desc: "회원가입 시 등록한 이메일로 접수된 예약을 자동으로 모아드립니다. 예약 번호 입력 없이 바로 확인할 수 있어요.",
        loginRequired: "로그인 후 회원 예약 확인 페이지를 이용할 수 있습니다.",
        login: "로그인하기",
        sidebarTitle: "정렬",
        userBadge: "회원 전용",
        searchPlaceholder: "예약 번호 또는 투어 이름으로 검색",
        sortLabel: "정렬",
        sortDepart: "출발 임박순",
        countUnit: "건",
        ...
        emptyCta: "투어 둘러보기",
        loadingTitle: "예약 내역을 불러오는 중...",
        loadFail: "예약 내역을 불러올 수 없습니다.",
        tabs: {
            all: "전체",
            pending: "결제 대기",
            confirmed: "신규 예약",
        ...
        submitCancelBtn: "취소 신청 완료",
        submittingCancelBtn: "처리 중...",
        cancelCloseBtn: "닫기",
        cancelDoneTitle: "취소 신청이 접수되었습니다",
    ...
    ja: {
        title: "会員予約確認",
        subtitle: "予約履歴",
        desc: "登録メールアドレスで受け付けた予約を自動的に表示します。予約番号の入力なしで確認できます。",
        loginRequired: "ログイン後にご利用いただけます。",
        login: "ログイン",
        sidebarTitle: "並び替え",
        userBadge: "会員専用",
        searchPlaceholder: "予約番号またはツアー名で検索",
        sortLabel: "並び替え",
        sortDepart: "出発が近い順",
        countUnit: "件",
        ...
        emptyCta: "ツアーを見る",
        loadingTitle: "予約履歴を読み込み中...",
        loadFail: "予約履歴を読み込めません。",
        tabs: {
            all: "すべて",
            pending: "支払い待ち",
            confirmed: "新規予約",
        ...
        cancelModalTitle: "予約キャンセル申請",
        cancelTargetLabel: "対象予約",
        policyTitle: "返金規定",
        ...
        submitCancelBtn: "キャンセル申請を送信",
        submittingCancelBtn: "送信中...",
        cancelCloseBtn: "閉じる",
        cancelDoneTitle: "キャンセル申請を受け付けました",
    ...
    en: {
        ...
        desc: "Bookings tied to your registered email show up automatically — no booking number lookup needed.",
        loginRequired: "Please log in to view your member bookings.",
        login: "Log in",
        sidebarTitle: "Sort",
        userBadge: "Members only",
        searchPlaceholder: "Search by booking no. or tour name",
        sortLabel: "Sort",
        sortDepart: "Upcoming departures",
        countUnit: "bookings",
        emptyTitle: "No bookings yet",
        emptyDesc: "There are no bookings in this category.",
        emptyCta: "Browse tours",
        loadingTitle: "Loading your bookings...",
        loadFail: "Could not load your bookings.",
        tabs: {
            all: "All",
            pending: "Pending",
            confirmed: "Confirmed",
        ...
        detailBtn: "Tour details",
        receiptBtn: "Booking receipt",
        ...
        receiptSection: "Booking details",
        receiptPaymentSection: "Payment details",
        receiptCustomer: "Lead traveler",
        receiptEmail: "Email",
        receiptPhone: "Phone",
        ...
        submitCancelBtn: "Submit cancellation",
        submittingCancelBtn: "Submitting...",
        cancelCloseBtn: "Close",
        cancelDoneTitle: "Cancellation request received",
...
function BookingsBoard({
    ...
    const filtered = useMemo(() => {
        ...
        return [...list].sort((a, b) => {
            const ad = new Date(a.departDate).getTime();
            const bd = new Date(b.departDate).getTime();
