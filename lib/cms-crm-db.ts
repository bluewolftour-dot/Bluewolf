...
const db = new DatabaseSync(dbPath) as unknown as Database;
...
function withInitLock(run: () => void) {
...
function initDb() {
    withInitLock(() => {
        ...
        ensureColumn("crm_bookings", "email", "TEXT NOT NULL DEFAULT ''");
        ensureColumn("crm_bookings", "customTitle", "TEXT NOT NULL DEFAULT ''");
        ensureColumn("crm_bookings", "customSummary", "TEXT NOT NULL DEFAULT ''");
        ensureColumn("crm_bookings", "totalAmount", "INTEGER NOT NULL DEFAULT 0");
        ensureColumn("crm_bookings", "depositAmount", "INTEGER NOT NULL DEFAULT 0");
        ensureColumn("cms_tours", "tagColors", "TEXT NOT NULL DEFAULT '{\"ko\":{},\"ja\":{},\"en\":{}}'");
        ensureColumn("crm_payment_orders", "email", "TEXT NOT NULL DEFAULT ''");
        ensureColumn("crm_payment_orders", "customTitle", "TEXT NOT NULL DEFAULT ''");
        ensureColumn("crm_payment_orders", "customSummary", "TEXT NOT NULL DEFAULT ''");
        ensureColumn("crm_payment_orders", "totalAmount", "INTEGER NOT NULL DEFAULT 0");
